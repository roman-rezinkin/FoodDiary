...
class FoodCDStack {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        let container = NSPersistentContainer(name: "FoodAppData")
    ...
    init(model: FoodDMM) {
        ...
        let pathToStoreFileInDocumentsDir =  applicationSupportDirectory.appendingPathComponent("FoodAppData.sqlite")
        ...
        if !FileManager.default.fileExists(atPath: pathToStoreFileInDocumentsDir.path) {
            ...
            let storeFileInBundle = Bundle.main.url(forResource: "FoodAppData", withExtension: "sqlite")
